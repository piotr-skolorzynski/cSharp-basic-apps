...
public class ContentEqualityChecker
{
    ...
    )
    {
        ...
        if (
            (leftValue is null && rightValue is not null)
    ...
    private static void PrintColumnCountIsDifferent(ITableData leftData, ITableData rightData)
    {
        Console.WriteLine(
    ...
    private static void PrintRowCountIsDifferent(ITableData leftData, ITableData rightData)
    {
        Console.WriteLine(
